...
Es fundamental que el país avance hacia un modelo de presupuestación basada en resultados, como lo plantea el Documento CONPES 4083 (Planeación, 2022). Este enfoque busca vincular explícitamente los recursos asignados con los resultados e impactos esperados, utilizando indicadores de desempeño que permitan evaluar la eficacia y eficiencia del gasto público y mejorar la rendición de cuentas.
