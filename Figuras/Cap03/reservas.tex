\begin{figure}
\centering
\caption{Evolución de reservas (compromisos sin obligar)}
\label{fig:reservas}
\begin{tikzpicture}
    \begin{axis}[
        ybar,
        ...
        xtick=data,
        xticklabel style={rotate=90, anchor=east}, % Rotación de 90 grados en los años
        ylabel={\% PIB},
        ymin=0, ymax=3.5,
        bar width=15pt,
        nodes near coords,
        ...
        \addplot coordinates {(2019,1.4) (2020,1.7) (2021,1.5) (2022,1.6) (2023,2.1) (2024,3.0)};
    \end{axis}
\end{tikzpicture}
%\vspace{0.1cm}
